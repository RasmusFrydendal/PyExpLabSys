...
# Form this client id. THIS_DIR is something like:
# /home/hpnow/PyExpLabSys/machines/hpnow-client-E
# The client ID is e.g. E, so the last item if we split over -
CLIENT_ID = THIS_DIR.split('-')[-1]
