...
def main():
    ...
    codenames = ['hpnow_temperature_production_lab', 'hpnow_humidity_production_lab']
    ...
    #livesocket = LiveSocket('Lab air logger', codenames)
    #livesocket.start()

    socket = DateDataPullSocket('Lab air logger', codenames,
                                timeouts=[1.0] * len(loggers))
    socket.start()

    db_logger = ContinuousDataSaver(continuous_data_table='dateplots_hpnow',
